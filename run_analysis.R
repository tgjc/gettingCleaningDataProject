#----------------------------------------------------------------------------------------------
# Please note: this script does not include steps to download/unzip/create data dir etc.
# Although I would liked to, I am short of time and there is no explicit requirement in
# for this in the assignment instructions. 
#
# Thanks for taking the time to review my code and good luck with your assignment :)
#----------------------------------------------------------------------------------------------

# Load required packages
library(reshape2)

# Set activity names and features to be extracted
